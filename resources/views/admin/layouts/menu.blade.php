<ul class="menu">
    ...
    <li class="menu_item">
        ...
        <ul class="sub">
            <li class="sub_item">
                ...
                <a href="{{ route('admin.supplies.muonts') }}" class="link">Xem thông tin tài sản</a>
            </li>
            <li class="sub_item">
                <!-- <a href="{{ route('admin.supplies.trats') }}" class="link">Trả tài sản</a> -->
                <a href="{{ route('admin.supplies.muonts') }}" class="link">Thêm tài sản mới</a>
            </li>   
            <li class="sub_item">
                <a href="{{ route('admin.supplies.indexts') }}" class="link">Cập nhật thông tin TS</a>
            </li>                      
        </ul>
    </li>
    <li class="menu_item">
    ...
    <li class="menu_item">
        <a href="" class="link"><i class="fal fa-money-bill-wave"></i> Nhập/Xuất dữ liệu</a>
        <ul class="sub">
            <li class="sub_item">
